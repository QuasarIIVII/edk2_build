...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1019f54a, 0x2560, 0x41b2, {0x87, 0xb0, 0x67, 0x50, 0xb9, 0x8f, 0x3e, 0xff}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CompatImageLoaderDxe";
...
{
  return CompatImageLoaderDxeEntryPoint (ImageHandle, SystemTable);
}
